...
namespace ssolve
{
    ...
    bool smatrixldltsolve(const ap::template_2d_array< amp::ampf<Precision> >& a,
    ...
    template<unsigned int Precision>
    bool smatrixsolve(ap::template_2d_array< amp::ampf<Precision> > a,
        const ap::template_1d_array< amp::ampf<Precision> >& b,
        int n,
        bool isupper,
        ap::template_1d_array< amp::ampf<Precision> >& x);
    template<unsigned int Precision>
    bool solvesystemldlt(const ap::template_2d_array< amp::ampf<Precision> >& a,
        const ap::template_1d_array< int >& pivots,
        ap::template_1d_array< amp::ampf<Precision> > b,
        int n,
        bool isupper,
        ap::template_1d_array< amp::ampf<Precision> >& x);
    template<unsigned int Precision>
    bool solvesymmetricsystem(ap::template_2d_array< amp::ampf<Precision> > a,
        ap::template_1d_array< amp::ampf<Precision> > b,
        int n,
        bool isupper,
        ap::template_1d_array< amp::ampf<Precision> >& x);
    ...
    *************************************************************************/
        ...
        ap::template_1d_array< amp::ampf<Precision> >& x)
    {
        ...
        amp::ampf<Precision> akm1;
        amp::ampf<Precision> akm1k;
        amp::ampf<Precision> bk;
        amp::ampf<Precision> bkm1;
        amp::ampf<Precision> denom;
        ...
        if( isupper )
        {
            ...
            while( k>=0 )
            {
                if( pivots(k)>=0 )
                {
                    ...
                    //
                    v = b(k);
                    amp::vsub(b.getvector(0, k-1), a.getcolumn(k, 0, k-1), v);
                ...
                else
                {
                    ...
                    //
                    v = b(k);
                    amp::vsub(b.getvector(0, k-2), a.getcolumn(k, 0, k-2), v);
                    v = b(k-1);
                    amp::vsub(b.getvector(0, k-2), a.getcolumn(k-1, 0, k-2), v);
            ...
            while( k<=n-1 )
            {
                if( pivots(k)>=0 )
                {
                    ...
                    // stored in column K+1 of A.
                    //
                    v = amp::vdotproduct(b.getvector(0, k-1), a.getcolumn(k, 0, k-1));
                    b(k) = b(k)-v;
                ...
                else
                {
                    ...
                    v = amp::vdotproduct(b.getvector(0, k-1), a.getcolumn(k, 0, k-1));
                    b(k) = b(k)-v;
                    v = amp::vdotproduct(b.getvector(0, k-1), a.getcolumn(k+1, 0, k-1));
                    b(k+1) = b(k+1)-v;
        ...
        else
        {
            ...
            while( k<=n-1 )
            {
                if( pivots(k)>=0 )
                {
                    ...
                    {
                        v = b(k);
                        amp::vsub(b.getvector(k+1, n-1), a.getcolumn(k, k+1, n-1), v);
                    }
                ...
                else
                {
                    ...
                    {
                        v = b(k);
                        amp::vsub(b.getvector(k+2, n-1), a.getcolumn(k, k+2, n-1), v);
                        v = b(k+1);
                        amp::vsub(b.getvector(k+2, n-1), a.getcolumn(k+1, k+2, n-1), v);
                    }
            ...
            while( k>=0 )
            {
                if( pivots(k)>=0 )
                {
                    ...
                    if( k+1<n )
                    {
                        v = amp::vdotproduct(b.getvector(k+1, n-1), a.getcolumn(k, k+1, n-1));
                        b(k) = b(k)-v;
                    }
                ...
                else
                {
                    ...
                    if( k+1<n )
                    {
                        v = amp::vdotproduct(b.getvector(k+1, n-1), a.getcolumn(k, k+1, n-1));
                        b(k) = b(k)-v;
                        v = amp::vdotproduct(b.getvector(k+1, n-1), a.getcolumn(k-1, k+1, n-1));
                        b(k-1) = b(k-1)-v;
                    }
        ...
        x.setbounds(0, n-1);
        amp::vmove(x.getvector(0, n-1), b.getvector(0, n-1));
        return result;
    }
    ...
    *************************************************************************/
        ...
        ap::template_1d_array< amp::ampf<Precision> >& x)
    {
        ...
        result = smatrixldltsolve<Precision>(a, pivots, b, n, isupper, x);
        return result;
    }
        ...
        ap::template_1d_array< amp::ampf<Precision> >& x)
    {
        ...
        if( isupper )
        {
            ...
            while( k>=1 )
            {
                if( pivots(k)>0 )
                {
                    ...
                    km1 = k-1;
                    v = b(k);
                    amp::vsub(b.getvector(1, km1), a.getcolumn(k, 1, km1), v);
                ...
                else
                {
                    ...
                    km1 = k-1;
                    v = b(k);
                    amp::vsub(b.getvector(1, km2), a.getcolumn(k, 1, km2), v);
                    v = b(k-1);
                    amp::vsub(b.getvector(1, km2), a.getcolumn(km1, 1, km2), v);
            ...
            while( k<=n )
            {
                if( pivots(k)>0 )
                {
                    ...
                    //
                    km1 = k-1;
                    v = amp::vdotproduct(b.getvector(1, km1), a.getcolumn(k, 1, km1));
                    b(k) = b(k)-v;
                ...
                else
                {
                    ...
                    v = amp::vdotproduct(b.getvector(1, km1), a.getcolumn(k, 1, km1));
                    b(k) = b(k)-v;
                    v = amp::vdotproduct(b.getvector(1, km1), a.getcolumn(kp1, 1, km1));
                    b(k+1) = b(k+1)-v;
        ...
        else
        {
            ...
            while( k<=n )
            {
                if( pivots(k)>0 )
                {
                    ...
                    if( k<n )
                    {
                        kp1 = k+1;
                        v = b(k);
                        amp::vsub(b.getvector(kp1, n), a.getcolumn(k, kp1, n), v);
                    }
                ...
                else
                {
                    ...
                    if( k<n-1 )
                    {
                        ...
                        kp2 = k+2;
                        v = b(k);
                        amp::vsub(b.getvector(kp2, n), a.getcolumn(k, kp2, n), v);
                        v = b(k+1);
                        amp::vsub(b.getvector(kp2, n), a.getcolumn(kp1, kp2, n), v);
                    }
            ...
            while( k>=1 )
            {
                if( pivots(k)>0 )
                {
                    ...
                    {
                        kp1 = k+1;
                        v = amp::vdotproduct(b.getvector(kp1, n), a.getcolumn(k, kp1, n));
                        b(k) = b(k)-v;
                    }
                ...
                else
                {
                    ...
                    if( k<n )
                    {
                        ...
                        v = amp::vdotproduct(b.getvector(kp1, n), a.getcolumn(k, kp1, n));
                        b(k) = b(k)-v;
                        v = amp::vdotproduct(b.getvector(kp1, n), a.getcolumn(km1, kp1, n));
                        b(k-1) = b(k-1)-v;
                    }
        ...
        x.setbounds(1, n);
        amp::vmove(x.getvector(1, n), b.getvector(1, n));
        return result;
    }
        ...
        ap::template_1d_array< amp::ampf<Precision> >& x)
    {
        ...
        result = solvesystemldlt<Precision>(a, pivots, b, n, isupper, x);
        return result;
    }
} // namespace
