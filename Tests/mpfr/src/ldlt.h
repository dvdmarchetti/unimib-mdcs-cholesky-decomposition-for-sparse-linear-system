...
namespace ldlt
{
    ...
    void smatrixldlt(ap::template_2d_array< amp::ampf<Precision> >& a,
        int n,
        bool isupper,
        ap::template_1d_array< int >& pivots);
    template<unsigned int Precision>
    void ldltdecomposition(ap::template_2d_array< amp::ampf<Precision> >& a,
        int n,
        bool isupper,
        ap::template_1d_array< int >& pivots);
    ...
    *************************************************************************/
        ...
        ap::template_1d_array< int >& pivots)
    {
        ...
        int kp;
        int kstep;
        amp::ampf<Precision> absakk;
        amp::ampf<Precision> alpha;
        amp::ampf<Precision> colmax;
        amp::ampf<Precision> d11;
        amp::ampf<Precision> d12;
        amp::ampf<Precision> d21;
        amp::ampf<Precision> d22;
        amp::ampf<Precision> r1;
        amp::ampf<Precision> rowmax;
        amp::ampf<Precision> t;
        amp::ampf<Precision> wk;
        amp::ampf<Precision> wkm1;
        amp::ampf<Precision> wkp1;
        int ii;
        int i1;
        int i2;
        ...
        //
        alpha = (1+amp::sqrt<Precision>(amp::ampf<Precision>(17)))/8;
        if( isupper )
        {
            ...
            while( k>=0 )
            {
                ...
                //
                absakk = amp::abs<Precision>(a(k,k));
                ...
                if( k>0 )
                {
                    ...
                    for(ii=2; ii<=k; ii++)
                    {
                        if( amp::abs<Precision>(a(ii-1,k))>amp::abs<Precision>(a(imax-1,k)) )
                        {
                            imax = ii;
                        }
                    }
                    colmax = amp::abs<Precision>(a(imax-1,k));
                }
                else
                {
                    colmax = 0;
                }
                if( amp::maximum<Precision>(absakk, colmax)==0 )
                {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            if( amp::abs<Precision>(a(imax-1,ii-1))>amp::abs<Precision>(a(imax-1,jmax-1)) )
                            {
                                jmax = ii;
                            }
                        }
                        rowmax = amp::abs<Precision>(a(imax-1,jmax-1));
                        if( imax>1 )
                        {
                            jmax = 1;
                            for(ii=2; ii<=imax-1; ii++)
                            {
                                if( amp::abs<Precision>(a(ii-1,imax-1))>amp::abs<Precision>(a(jmax-1,imax-1)) )
                                {
                                    jmax = ii;
                                }
                            }
                            rowmax = amp::maximum<Precision>(rowmax, amp::abs<Precision>(a(jmax-1,imax-1)));
                        }
                        vv = colmax/rowmax;
                        ...
                        {
                            if( amp::abs<Precision>(a(imax-1,imax-1))>=alpha*rowmax )
                            {
                    ...
                    if( kp+1!=kk+1 )
                    {
                        ...
                        // submatrix A(0:K,0:K)
                        //
                        amp::vmove(temp.getvector(0, kp-1), a.getcolumn(kk, 0, kp-1));
                        amp::vmove(a.getcolumn(kk, 0, kp-1), a.getcolumn(kp, 0, kp-1));
                        amp::vmove(a.getcolumn(kp, 0, kp-1), temp.getvector(0, kp-1));
                        amp::vmove(temp.getvector(kp+1, kk-1), a.getcolumn(kk, kp+1, kk-1));
                        amp::vmove(a.getcolumn(kk, kp+1, kk-1), a.getrow(kp, kp+1, kk-1));
                        amp::vmove(a.getrow(kp, kp+1, kk-1), temp.getvector(kp+1, kk-1));
                        t = a(kk,kk);
                        a(kk,kk) = a(kp,kp);
                        a(kp,kp) = t;
                        if( kstep==2 )
                    ...
                    if( kstep==1 )
                    {
                        ...
                        {
                            vv = -r1*a(i,k);
                            amp::vadd(a.getrow(i, i, k-1), a.getcolumn(k, i, k-1), vv);
                        }
                        
                        //
                        // Store U(K+1) in column K+1
                        //
                        amp::vmul(a.getcolumn(k, 0, k-1), r1);
                    }
                    else
                    {
                        ...
                        if( k>1 )
                        {
                            ...
                            for(j=k-2; j>=0; j--)
                            {
                                ...
                                amp::vsub(a.getcolumn(j, 0, j), a.getcolumn(k, 0, j), wk);
                                amp::vsub(a.getcolumn(j, 0, j), a.getcolumn(k-1, 0, j), wkm1);
                                a(j,k) = wk;
                                a(j,k-1) = wkm1;
                            }
                        }
            ...
            while( k<=n-1 )
            {
                ...
                else
                {
                    ...
                    if( kp!=kk )
                    {
                        ...
                        if( kp+1<n )
                        {
                            amp::vmove(temp.getvector(kp+1, n-1), a.getcolumn(kk, kp+1, n-1));
                            amp::vmove(a.getcolumn(kk, kp+1, n-1), a.getcolumn(kp, kp+1, n-1));
                            amp::vmove(a.getcolumn(kp, kp+1, n-1), temp.getvector(kp+1, n-1));
                        }
                        amp::vmove(temp.getvector(kk+1, kp-1), a.getcolumn(kk, kk+1, kp-1));
                        amp::vmove(a.getcolumn(kk, kk+1, kp-1), a.getrow(kp, kk+1, kp-1));
                        amp::vmove(a.getrow(kp, kk+1, kp-1), temp.getvector(kk+1, kp-1));
                        t = a(kk,kk);
                        a(kk,kk) = a(kp,kp);
                        a(kp,kp) = t;
                        if( kstep==2 )
                    ...
                    if( kstep==1 )
                    {
                        ...
                        if( k+1<n )
                        {
                            ...
                            {
                                vv = -d11*a(ii,k);
                                amp::vadd(a.getrow(ii, k+1, ii), a.getcolumn(k, k+1, ii), vv);
                            }
                            
                            //
                            // Store L(K+1) in column K+1
                            //
                            amp::vmul(a.getcolumn(k, k+1, n-1), d11);
                        }
                    }
                    else
                    {
                        ...
                        if( k<n-2 )
                        {
                            ...
                            for(j=k+2; j<=n-1; j++)
                            {
                                ...
                                amp::vsub(a.getcolumn(j, j, n-1), a.getcolumn(k, j, n-1), wk);
                                amp::vsub(a.getcolumn(j, j, n-1), a.getcolumn(k+1, j, n-1), wkp1);
                                a(j,k) = wk;
                                a(j,k+1) = wkp1;
                            }
                        }
        ...
        if( isupper )
        {
            ...
            while( k>=1 )
            {
                ...
                if( k>1 )
                {
                    ...
                    for(ii=2; ii<=k-1; ii++)
                    {
                        if( amp::abs<Precision>(a(ii,k))>amp::abs<Precision>(a(imax,k)) )
                        {
                            imax = ii;
                        }
                    }
                    colmax = amp::abs<Precision>(a(imax,k));
                }
                else
                {
                    colmax = 0;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            if( amp::abs<Precision>(a(imax,ii))>amp::abs<Precision>(a(imax,jmax)) )
                            {
                                jmax = ii;
                            }
                        }
                        rowmax = amp::abs<Precision>(a(imax,jmax));
                        if( imax>1 )
                        {
                            jmax = 1;
                            for(ii=2; ii<=imax-1; ii++)
                            {
                                if( amp::abs<Precision>(a(ii,imax))>amp::abs<Precision>(a(jmax,imax)) )
                                {
                                    jmax = ii;
                                }
                            }
                            rowmax = amp::maximum<Precision>(rowmax, amp::abs<Precision>(a(jmax,imax)));
                        }
                        vv = colmax/rowmax;
                        if( absakk>=alpha*colmax*vv )
                        {
                        ...
                        {
                            if( amp::abs<Precision>(a(imax,imax))>=alpha*rowmax )
                            {
                    ...
                    if( kp!=kk )
                    {
                        ...
                        //
                        i1 = kp-1;
                        amp::vmove(temp.getvector(1, i1), a.getcolumn(kk, 1, i1));
                        amp::vmove(a.getcolumn(kk, 1, i1), a.getcolumn(kp, 1, i1));
                        amp::vmove(a.getcolumn(kp, 1, i1), temp.getvector(1, i1));
                        i1 = kp+1;
                        i2 = kk-1;
                        amp::vmove(temp.getvector(i1, i2), a.getcolumn(kk, i1, i2));
                        amp::vmove(a.getcolumn(kk, i1, i2), a.getrow(kp, i1, i2));
                        amp::vmove(a.getrow(kp, i1, i2), temp.getvector(i1, i2));
                        t = a(kk,kk);
                        a(kk,kk) = a(kp,kp);
                        a(kp,kp) = t;
                        if( kstep==2 )
                    ...
                    if( kstep==1 )
                    {
                        ...
                        for(i=1; i<=k-1; i++)
                        {
                            i2 = k-1;
                            vv = -r1*a(i,k);
                            amp::vadd(a.getrow(i, i, i2), a.getcolumn(k, i, i2), vv);
                        }
                        ...
                        //
                        i2 = k-1;
                        amp::vmul(a.getcolumn(k, 1, i2), r1);
                    }
                    else
                    {
                        ...
                        if( k>2 )
                        {
                            ...
                            for(j=k-2; j>=1; j--)
                            {
                                wkm1 = d12*(d11*a(j,k-1)-a(j,k));
                                wk = d12*(d22*a(j,k)-a(j,k-1));
                                amp::vsub(a.getcolumn(j, 1, j), a.getcolumn(k, 1, j), wk);
                                i1 = k-1;
                                amp::vsub(a.getcolumn(j, 1, j), a.getcolumn(i1, 1, j), wkm1);
                                a(j,k) = wk;
                                a(j,k-1) = wkm1;
                            }
                        }
            ...
            while( k<=n )
            {
                ...
                else
                {
                    ...
                    if( kp!=kk )
                    {
                        ...
                        {
                            i1 = kp+1;
                            amp::vmove(temp.getvector(i1, n), a.getcolumn(kk, i1, n));
                            amp::vmove(a.getcolumn(kk, i1, n), a.getcolumn(kp, i1, n));
                            amp::vmove(a.getcolumn(kp, i1, n), temp.getvector(i1, n));
                        }
                        i1 = kk+1;
                        i2 = kp-1;
                        amp::vmove(temp.getvector(i1, i2), a.getcolumn(kk, i1, i2));
                    ...
                    if( kstep==1 )
                    {
                        ...
                        if( k<n )
                        {
                            ...
                            for(ii=k+1; ii<=n; ii++)
                            {
                                ...
                                i2 = ii;
                                vv = -d11*a(ii,k);
                                amp::vadd(a.getrow(ii, i1, i2), a.getcolumn(k, i1, i2), vv);
                            }
                            ...
                            //
                            i1 = k+1;
                            amp::vmul(a.getcolumn(k, i1, n), d11);
                        }
                    }
                    else
                    {
                        ...
                        if( k<n-1 )
                        {
                            ...
                            for(j=k+2; j<=n; j++)
                            {
                                ...
                                wkp1 = d21*(d22*a(j,k+1)-a(j,k));
                                ii = k+1;
                                amp::vsub(a.getcolumn(j, j, n), a.getcolumn(k, j, n), wk);
                                amp::vsub(a.getcolumn(j, j, n), a.getcolumn(ii, j, n), wkp1);
                                a(j,k) = wk;
                                a(j,k+1) = wkp1;
                            }
                        }
