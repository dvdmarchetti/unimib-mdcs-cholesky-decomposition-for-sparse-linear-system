...
namespace reflections
{
    ...
    *************************************************************************/
        ...
        amp::ampf<Precision>& tau)
    {
        ...
        if( mx!=0 )
        {
            if( mx<=amp::ampf<Precision>::getAlgoPascalMinNumber()/amp::ampf<Precision>::getAlgoPascalEpsilon() )
            {
                s = amp::ampf<Precision>::getAlgoPascalMinNumber()/amp::ampf<Precision>::getAlgoPascalEpsilon();
                v = 1/s;
                amp::vmul(x.getvector(1, n), v);
                mx = mx*v;
            }
            else
            {
                if( mx>=amp::ampf<Precision>::getAlgoPascalMaxNumber()*amp::ampf<Precision>::getAlgoPascalEpsilon() )
                {
                    s = amp::ampf<Precision>::getAlgoPascalMaxNumber()*amp::ampf<Precision>::getAlgoPascalEpsilon();
                    v = 1/s;
                    amp::vmul(x.getvector(1, n), v);
                    mx = mx*v;
                }
    ...
    *************************************************************************/
        ...
        ap::template_1d_array< amp::ampf<Precision> >& work)
    {
        ...
        {
            t = v(i+1-m1);
            amp::vadd(work.getvector(n1, n2), c.getrow(i, n1, n2), t);
        }
        ...
        {
            t = v(i-m1+1)*tau;
            amp::vsub(c.getrow(i, n1, n2), work.getvector(n1, n2), t);
        }
    }
    ...
    *************************************************************************/
        ...
        ap::template_1d_array< amp::ampf<Precision> >& work)
    {
        ...
        for(i=m1; i<=m2; i++)
        {
            t = amp::vdotproduct(c.getrow(i, n1, n2), v.getvector(1, vm));
            t = t*tau;
            amp::vsub(c.getrow(i, n1, n2), v.getvector(1, vm), t);
        }
    }
} // namespace
